    ...
    @slot('contentOfContainer')
        ...
        <x-contentSection>
            <x-slot name="contentOfContentSection">
                <x-tableDatatable header="Transaction Management" tableId="transactionManagementTable" :oneRowThArray="['No.', 'Code', 'Campaign Name', 'User', 'Status', 'Payment Proof', 'Price Total', 'Action']" />
            </x-slot>
        </x-contentSection>
